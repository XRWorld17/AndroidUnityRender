...
Java_com_zhx_unitytransfer_UnityTransfer_onVideoBuffer(
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_initAssetsLoader(JNIEnv *env, jclass type, jstring json_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_loadAsset(JNIEnv *env, jclass type, jint assetId) {
#ifdef USE_UNITY_NATIVE_SEND_MESSAGE
    if(mConnector != nullptr){
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_setRecordAction(JNIEnv *env, jclass type, jint recordAction) {
#ifdef USE_UNITY_NATIVE_SEND_MESSAGE
    if(mConnector != nullptr){
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_enableBlur(JNIEnv *env, jclass type,
                                                        jboolean isEnable) {
#ifdef USE_UNITY_NATIVE_SEND_MESSAGE
    if(mConnector != nullptr){
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_pauseAssetAudio(JNIEnv *env, jclass type,
                                                             jboolean isPause) {
#ifdef USE_UNITY_NATIVE_SEND_MESSAGE
    if(mConnector != nullptr){
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_cleanUpAssetsCache(JNIEnv *env, jclass type) {
#ifdef USE_UNITY_NATIVE_SEND_MESSAGE
    if(mConnector != nullptr){
...
extern "C" JNIEXPORT void JNICALL
Java_com_zhx_unitytransfer_UnityTransfer_onMonalisaData(JNIEnv *env, jclass type, jlong msgPtr) {
    if(mConnector != nullptr){
